  ...
  return (
    <Sheet open={openAuthSheet} onOpenChange={setOpenAuthSheet}>
      ...
      <SheetPortal>
        ...
        <SheetPrimitive.Content className="fixed inset-y-0 right-0 z-50 h-full w-full sm:max-w-[480px] bg-background border-l shadow-2xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right data-[state=open]:duration-500 data-[state=closed]:duration-300 overflow-y-auto">
          {/* Close Button */}
          <button
